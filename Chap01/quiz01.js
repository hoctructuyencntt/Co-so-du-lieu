...
$(document).ready(function () {
    ...
    //*****************************************************************************
    var question1 = {
        question: "1. The logical layer of the ANSI/SPARC model provides which of the following?",
        answers: ["A. Physical data independence","B. Parent-child relationships", "C. Logical data independence","D. Encapsulation"],
        correct: 0
    };

    var question2 = {
        question: "2. The external layer of the ANSI/SPARC model provides which of the following?",
        answers: ["A. Physical data independence","B. Parent-child relationships", "C. Logical data independence", "D. Encapsulation"],
        correct: 2
    };

    var question3 = {
        question: '3. Which of the following is not true regarding user views?',
        answers: ['A. Application programs reference them.','B. People querying the database reference them.','C. They can be tailored to the needs of the database user.','D. Data updates are shown in a delayed fashion.'],
        correct: 3
    }
var question4 = {
        question: "4. Which of the following is true regarding the hierarchical database model?",
        answers: ["A. It was first developed by Peter Chen.",
...
"D. Records are connected using physical address pointers."],
    ...
    var question5 = {
        question: "5. Which of the following is true regarding the network database model?",
        answers: ["A. It was first developed by E.F. Codd.",
"B. Data and methods are stored together in the database.",
"C. Each node may have many parents.",
"D. Records are connected using common physical address pointers."],
    ...
    var question6 = {
        question: '6. Which of the following is true of the relational database model?',
        answers: ['A. It was first developed by Charles Bachman.',
'B. Data and methods are stored together in the database.',
...
var question7 = {
        question: "7. Which of the following is true regarding the object-oriented model?",
        answers: ["A. It was first developed by Charles Bachman.",
"B. Data and methods are stored together in the database.",
...
"D. Records are connected using common data items in each record."],
    ...
    var question8 = {
        question: "8. Which of the following is true regarding the object-relational model?",
        answers: ["A. It serves only a niche market and most experts believe it will stay that way.",
...
"D. It was developed by adding relational-like properties to the object-oriented model."],
    ...
    function showResults() {
        ...
        if (correctAns == 8) {
            ...
            a.href = "https://hoctructuyencntt.com/2021/05/21/tai-nguyen-hoc-tap/";
