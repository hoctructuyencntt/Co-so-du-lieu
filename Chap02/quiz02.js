...
$(document).ready(function () {
    ...
    //*****************************************************************************
    var question1 = {
        question: "1. Examples of an attribute are",
        answers: ["A. An employee",
...
"D. An alphabetical listing of employees"],
    ...
    var question2 = {
        question: "2. Which of the following denotes the cardinality of “zero, one, or more” on a relationship line?",
        answers: ["A. A perpendicular tick mark near the end of the line and a crow’s foot at the line end",
...
"D. A circle and a perpendicular tick mark near the end of the line"],
    ...
    var question3 = {
        question: '3. If a product can be manufactured in many plants, and a plant can manufacture many products, this is an example of which type of relationship?',
        answers: ['A. One-to-one',
'B. One-to-many',
'C. Many-to-many',
'D. Recursive'],
        correct: 2
...
var question4 = {
        question: "4. Which of the following are examples of recursive relationships?",
        answers: ["A. An organizational unit made up of departments",
...
"D. An employee who has many dependents"],
    ...
    var question5 = {
        question: "5. A referential constraint",
        answers: ["A. Must have primary key and foreign key columns that have identical names",
...
"D. Ensures that a foreign key value always refers to an existing primary key value in the parent table"],
    ...
    function showResults() {
        ...
        if (correctAns == 5) {
            ...
            a.href = "https://hoctructuyencntt.com/2021/07/01/mo-hinh-co-so-du-lieu-quan-he-phan-1-muc-khai-niem/";
